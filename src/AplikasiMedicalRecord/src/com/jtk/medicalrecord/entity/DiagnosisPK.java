...
public class DiagnosisPK implements Serializable {
    ...
    public DiagnosisPK(String pasId, long medId) {
        this.pasId = pasId;
        this.medId = medId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DiagnosisPK)) {
            return false;
        }
        DiagnosisPK other = (DiagnosisPK) object;
    ...
    public String toString() {
        return "com.jtk.medicalrecord.entity.DiagnosisPK[ pasId=" + pasId + ", medId=" + medId + " ]";
    }
