 ...
 */
@Embeddable
public class AnamnesaPK implements Serializable {
    ...
    public AnamnesaPK(String pasId, long medId) {
        this.pasId = pasId;
        this.medId = medId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AnamnesaPK)) {
            return false;
        }
        AnamnesaPK other = (AnamnesaPK) object;
    ...
    public String toString() {
        return "com.jtk.medicalrecord.entity.AnamnesaPK[ pasId=" + pasId + ", medId=" + medId + " ]";
    }
