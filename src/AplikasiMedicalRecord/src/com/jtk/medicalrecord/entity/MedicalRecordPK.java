...
public class MedicalRecordPK implements Serializable {
    ...
    public MedicalRecordPK(String pasId, long medId) {
        this.pasId = pasId;
        this.medId = medId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MedicalRecordPK)) {
            return false;
        }
        MedicalRecordPK other = (MedicalRecordPK) object;
    ...
    public String toString() {
        return "com.jtk.medicalrecord.entity.MedicalRecordPK[ pasId=" + pasId + ", medId=" + medId + " ]";
    }
